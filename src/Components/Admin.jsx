  ...
  return (
     <div className="admin-main">
        ...
        <div className='inputonly-container'>
         <input value={adminemailinput} className='input' placeholder='Email...' onChange={(e)=>{setadminemailinput(e.target.value)}}/>
         <p className='caution'>{errorcount.adminemail}</p>
         </div>
         <div className='inputonly-container'>
         <input value={adminpassinput} className='input' type={showpassword ? "text" : "password"} placeholder='Password...' onChange={(e)=>{setadminpassInput(e.target.value)}}/>
        <p className='caution'>{errorcount.adminpassword}</p>
         ...
         <button className='frm-btn' onClick={()=>{handleadminInput()}}>login</button>
         <div className='Admin-btm-label'><label className='brand me-3 ms-3'>
